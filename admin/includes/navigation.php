...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="dashboard" class="logo">
      ...
      <span class="logo-lg"><b>Agra Restaurant</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="banner">
            <i class="fa fa-arrow-right"></i> <span>Banner</span>
          </a>
        </li>
        <li class="treeview">
          <a href="category">
        ...
        <li class="treeview">
          <a href="special-menu">
            <i class="fa fa-star"></i> <span>Special Menu</span>
          </a>
        </li>
        <li class="treeview">
          <a href="testimonial">
            <i class="fa fa-book"></i> <span>Testimonial</span>
          </a>
        </li>
        <li class="treeview">
          <a href="events">
